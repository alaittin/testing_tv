 ...
 * @package    		Model
 */
class EvenementType extends Cmodel
{
	/**
	 * Name of the current table
	 * @var string
	 */
	protected $strTable = 'tl_tvfi_bdf_evenement_type';
...
#	protected $hasMany = array( 'Evenement');
#	protected $belongsTo = array( 'EvenementTypeGroup');
