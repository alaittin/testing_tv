...
/**
 * Class ModuleBDFLastSocietesVendeuses 
 *
 * @copyright		2010 - Kantik / Noodle 
 * @author			Erwan Ripoll <eripoll@noodle.fr>
 * @package    Controller
 */
class ModuleBDFLastSocietesVendeuses extends FrontEndBloc
{
	 ...
	 * @var string
	 */
	protected $contentTemplate = 'fe_bdf_last_societes_vendeuses';
	...
	public function generate()
	{
		if (TL_MODE == 'BE')
		{
			...
			$objTemplate->wildcard = '### LISTE DES DERNIERES SOCIETES MISES A JOUR (BDF) ###';
	...
	protected function compile()
	{
		...
		$societes = $societe->getAll( 'tstamp desc', array( 'published = 1'), $this->bloc_result_number );
