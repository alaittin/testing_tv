...
/**
 * Class ModuleBDFNewSocietesVendeuses 
 *
 * @copyright		2010 - Kantik / Noodle 
 * @author			Erwan Ripoll <eripoll@noodle.fr>
 * @package    Controller
 */
class ModuleBDFNewSocietesVendeuses extends FrontEndBloc
{
	 ...
	 * @var string
	 */
	protected $contentTemplate = 'fe_bdf_new_societes_vendeuses';
	...
	public function generate()
	{
		if (TL_MODE == 'BE')
		{
			...
			$objTemplate->wildcard = '### LISTE DES NOUVELLES SOCIETES (BDF) ###';
