 ...
 * @package    		Model
 */
class Version extends Emodel
{
	/**
	 * Name of the current table
	 * @var string
	 */
	protected $strTable = 'tl_tvfi_version';
	...
	protected $manyToMany = array( 'Programme' => 'tl_tvfi_programme_to_version' );
	...
	{
		$_themes = $this->all;
		$_field = 'ver_nom_' . $GLOBALS['TL_LANGUAGE'];
