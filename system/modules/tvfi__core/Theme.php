 ...
 * @package    		Model
 */
class Theme extends Cmodel
{
	/**
	 * Name of the current table
	 * @var string
	 */
	protected $strTable = 'tl_tvfi_theme_programme';
	...
	protected $manyToMany = array( 'SocieteAcheteuse' => 'tl_tvfi_bdi_societe_acheteuse_to_theme', 'Programme' => 'tl_tvfi_programme_to_theme' );
	...
	{
		$_field = 'tpg_libelle_' . $GLOBALS['TL_LANGUAGE'];
		return $this->$_field;
	}
