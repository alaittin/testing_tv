						...
						<div class="box_653 marginBottom0 toggledbox boxTarifs">
							...
							<div class="boxBottom">
								...
								<div class="boxTabs" id="pays_tabs">
									...
									<ul class="boxTabsNav mootabs_title">
										<?php foreach($this->pays->tarifsGroupedByType as $type=>$tarifs): ?>
										<li title="Tab_<?php echo standardize($type); ?>"><a><span><?php echo $type; ?></span></a></li>
										<?php endforeach; ?>
									</ul>
									...
									<?php foreach($this->pays->tarifsGroupedByType as $type=>$tarifs): ?>
									<div class="mootabs_panel tabs" id="Tab_<?php echo standardize($type); ?>">
										<table class="tableau zebraTable" id="tarifs" summary="Tarifs">
											<thead>
												<tr>
