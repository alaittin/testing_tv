...
/**
 * Class ModuleBDIOrganigrammeSocieteAcheteuse 
 *
 * @copyright		2010 - Kantik / Noodle 
 * @author			Erwan Ripoll <eripoll@noodle.fr>
 * @package    Controller
 */
class ModuleBDIOrganigrammeSocieteAcheteuse extends FrontEndBloc
{
	 ...
	 * @var string
	 */
	protected $contentTemplate = 'fe_bdi_organigramme_societe_acheteuse';
	...
	public function generate()
	{
		if (TL_MODE == 'BE')
		{
			...
			$objTemplate->wildcard = '### ORGANIGRAMME SOCIETE ACHETEUSE ###';
	...
	protected function compile()
	{
		...
		$contentTemplate->ficheLink = ampersand(($this->Environment->base. $GLOBALS['TL_LANGUAGE'] .'/bdi/societes/presentation/fiche/'.$_GET['fiche'] . $GLOBALS['TL_CONFIG']['urlSuffix']), ENCODE_AMPERSANDS);
